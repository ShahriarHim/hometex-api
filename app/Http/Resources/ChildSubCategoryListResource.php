...
/**
 * ChildSubCategoryListResource
 * 
 * Resource for level 3 categories (child categories) in the unified Category model
 * 
 * @property mixed $id
 * @property mixed $name
 * @property mixed $parent  Parent category (level 2 - subcategory)
 * @property mixed $slug
...
class ChildSubCategoryListResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'sub_category_name' => $this->parent?->name,
            'sub_category_id' => $this->parent_id,
            'slug' => $this->slug,
